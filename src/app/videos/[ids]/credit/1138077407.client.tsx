...
export default function Credit1138077407() {
  const [lang, setLang] = React.useState<LanguageCode>('ne');

  return (
    <div className="flex flex-col gap-y-4 pb-4 whitespace-pre-line">
      <CreditTitle data={data?.titles as string[]} />
      <p className="text-center text-lg font-medium">{data?.description}</p>

      ...
      <Modal state={state}>
        <div className={classes.Dialog}>
          <div className={[classes.Content].join(' ')} {...titleProps}>
            <h1>이야기를 재생하시겠습니까?</h1>
            {param22Name === undefined && <span>Вы хотите посмотреть историю?</span>}
            <h4>(헤드폰이 있다면 헤드폰을 착용하세요)</h4>
            {param22Name === undefined && <span>Надевайте наушники, если у вас есть</span>}
          </div>
          <div className={classes.ButtonWrapper}>
            <Button onPress={() => state.close()} className={classes.ConfirmButton}>
              <pre>
                {`네\n`}
